> ⚖️ **LEGAL NOTICE: PATENT PENDING** > The system architecture, sensor fusion methodology (Crowd Instability Index), and adaptive thresholding algorithms detailed in this repository are subject to an active, pending patent application. This code is provided strictly for academic and professional portfolio review. Commercial use, reproduction, or distribution without explicit permission is strictly prohibited.
